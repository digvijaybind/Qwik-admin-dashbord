...
const Modal = () => {
  ...
  return (
    <div
      className={`${
        show ? "block" : "hidden"
      } bg-white shadow-md  relative w-[500px] px-[30px] px-[40px]`}
    >
      ...
      <div className="w-[100%]">
        ...
        <div className="flex justify-between w-[100%]">
          ...
          <TextInput className={"w-[48%]"} label={"Email Address"}></TextInput>
        </div>
        <div className="flex justify-between w-[100%]">
          <TextInput className={"w-[48%]"} label={"Contact Number"}></TextInput>
          <TextInput className={"w-[48%]"} label={"Aircraft Type"}></TextInput>
        </div>
        <div className="flex justify-between w-[100%]">
